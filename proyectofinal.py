...
try:
   BASE_DIR = os.path.dirname(os.path.abspath(__file__))
   imagen = Image.open(os.path.join(BASE_DIR,"ventas2025.jpg")) # Cambia por el archivo del alumno
...
estilo.configure("TButton",
                 font=("Arial", 12),
                 padding=10,
                 background="#1E90FF",  # Color de fondo azul
                 foreground="black",     # Color del texto negro
                 relief="flat",          # Sin borde, para que no aparezca un contorno
                 )
